...
export const Terminal = ({
    ...
    const content = (
        <div
            ref={containerRef}
            className={cn(
                "z-0 h-full w-full rounded-xl border border-zinc-800 bg-zinc-950 shadow-2xl overflow-hidden",
                className
            )}
        >
            <div className="flex flex-col gap-y-2 border-b border-zinc-800 p-4 bg-zinc-900/50">
            ...
            <div className="p-4 overflow-auto font-mono text-zinc-300 h-full">
